                ...
                {expandedId === tpl.id && (
                  <div className="mt-4 pt-4 border-t space-y-3 text-sm">
                    <ConfigSection title="Campanha" items={[
                      ...
                      ["Quantidade", tpl.config.campaign_config?.quantity],
                    ...
                    <ConfigSection title="Conjunto" items={[
                      ...
                      ["Qtd / campanha", tpl.config.default_adset_qty],
                      ["Países", tpl.config.adset_config?.countries],
                      ["Idade", `${tpl.config.adset_config?.age_min} – ${tpl.config.adset_config?.age_max}`],
          ...
          <div className="space-y-6 py-2">
            ...
            <fieldset className="border rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><Label className="text-xs">Quantidade</Label><Input type="number" min={1} className="h-8 text-sm" value={editConfig.campaign_config?.quantity || 1} onChange={(e) => updateConfig("campaign_config", "quantity", Math.max(1, parseInt(e.target.value) || 1))} /></div>
              </div>
            ...
            <fieldset className="border rounded-lg p-4 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div><Label className="text-xs">Qtd por campanha (padrão)</Label><Input type="number" min={1} className="h-8 text-sm" value={editConfig.default_adset_qty || 1} onChange={(e) => setEditConfig((p: any) => ({ ...p, default_adset_qty: Math.max(1, parseInt(e.target.value) || 1) }))} /></div>
              </div>
              <div className="grid grid-cols-3 gap-3">
